export default function Home() {
  return (
    <div className="flex flex-col w-full h-screen text-center justify-center gap-8">
      <h1 className="text-6xl font-bold uppercase">Under Construction</h1>
      <p className="w-1/3 mx-auto text-lg">
